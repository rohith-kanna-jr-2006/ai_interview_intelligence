...
## 7. Fraud Detection Prompt (Advanced Feature)
> "Monitor real-time video, audio, and behavioral signals to detect cheating or suspicious activities. Flag events such as multiple face detection, voice mismatch, excessive tab switching, or abnormal eye movement patterns. Generate a fraud risk score and alert if threshold exceeds safe limits."
...
> *"Our system is a multimodal AI pipeline uniting LLMs, speech recognition, and computer vision to autonomously conduct, monitor, and evaluate technical interviews in real-time."*
